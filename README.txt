...
Input is received through a UNIX socket created by the program at startup, in the form of 4 byte udp packets. I use a separate python program to receive commands from an Android app and send them to the flight controller through the socket. You can edit Input::Update to change how input is received.
